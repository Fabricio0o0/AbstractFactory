...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        Shape shape1 = shapeBlueFactory.getCircle(1);  // Correção no nome do método
        shape1.draw();

        Shape shape2 = shapeBlueFactory.getRectangle(2);  // Correção no nome da variável e no método
        shape2.draw();
